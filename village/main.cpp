...
{
    glBegin(GL_POLYGON);
    glColor3ub(210, 70, 100);
    glColor3ub(130, 97, 50);
...
{
    glBegin(GL_POLYGON);
    glColor3ub(255, 219, 10);
    glColor3ub(160, 130, 90);
    glColor3ub(237, 170, 55);
...
void handleKeypress(unsigned char key, int x, int y)
{
    ...
    case  'd':
        ...
        glutCreateWindow("Village | Day Mode");
    ...
    case 'n':
        ...
        glutInitWindowSize(1240, 750);
        glutInitWindowPosition((glutGet(GLUT_SCREEN_WIDTH)-1240)/2,(glutGet(GLUT_SCREEN_HEIGHT)-750)/2);
        glutCreateWindow("Village | Night Mode");
        glutKeyboardFunc(handleKeypress);
